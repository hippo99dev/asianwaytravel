...
class AsianQuotation(models.Model):
    ...
    asian_quotation_schedule_ids = fields.Many2many(string='Asian Quotation Schedule', comodel_name='asian.quotation.schedule', copy=False, compute='_compute_asian_quotation_schedule_ids', inverse='_inverse_asian_quotation_schedule_ids', store=True, readonly=False)
    asian_spreadsheet_product_ids = fields.Many2many(string='Asian Spreadsheet Product', comodel_name='asian.spreadsheet.product', copy=False, compute='_compute_asian_spreadsheet_product_ids', inverse='_inverse_asian_spreadsheet_product_ids', store=True, readonly=False)
    ...
    asian_spreadsheet_team_option_ids = fields.Many2many(string='Asian Spreadsheet Team Option', comodel_name='asian.spreadsheet.team.option', copy=False, compute='_compute_asian_spreadsheet_team_option_ids')
    asian_spreadsheet_net_option_ids = fields.Many2many(string='Asian Spreadsheet Net Option', comodel_name='asian.spreadsheet.net.option', copy=False, compute='_compute_asian_spreadsheet_net_option_ids')
    ...
    has_applied = fields.Boolean(compute='_compute_applied_asian_spreadsheet_option_id', copy=False)
    ...
    price_type_car_4 = fields.Float(string='Xe 4 chỗ', compute='_compute_team_option_car', inverse='_inverse_team_option_car', store=True, readonly=False)
    price_type_car_7 = fields.Float(string='Xe 7 chỗ', compute='_compute_team_option_car', inverse='_inverse_team_option_car', store=True, readonly=False)
    price_type_car_16 = fields.Float(string='Xe 16 chỗ', compute='_compute_team_option_car', inverse='_inverse_team_option_car', store=True, readonly=False)
    price_type_car_29 = fields.Float(string='Xe 29 chỗ', compute='_compute_team_option_car', inverse='_inverse_team_option_car', store=True, readonly=False)
    price_type_car_35 = fields.Float(string='Xe 35 chỗ', compute='_compute_team_option_car', inverse='_inverse_team_option_car', store=True, readonly=False)
    price_type_car_45_1 = fields.Float(string='Xe 45 chỗ', compute='_compute_team_option_car', inverse='_inverse_team_option_car', store=True, readonly=False)
    price_type_car_45_2 = fields.Float(string='Xe 45 chỗ', compute='_compute_team_option_car', inverse='_inverse_team_option_car', store=True, readonly=False)
    price_type_car_45_3 = fields.Float(string='Xe 45 chỗ', compute='_compute_team_option_car', inverse='_inverse_team_option_car', store=True, readonly=False)
    price_type_car_45_4 = fields.Float(string='Xe 45 chỗ', compute='_compute_team_option_car', inverse='_inverse_team_option_car', store=True, readonly=False)

    team_car_4 = fields.Float(string='Xe 4 chỗ', compute='_compute_team_option_car', inverse='_inverse_team_option_car', store=True, readonly=False)
    team_car_7 = fields.Float(string='Xe 7 chỗ', compute='_compute_team_option_car', inverse='_inverse_team_option_car', store=True, readonly=False)
    team_car_16 = fields.Float(string='Xe 16 chỗ', compute='_compute_team_option_car', inverse='_inverse_team_option_car', store=True, readonly=False)
    team_car_29 = fields.Float(string='Xe 29 chỗ', compute='_compute_team_option_car', inverse='_inverse_team_option_car', store=True, readonly=False)
    team_car_35 = fields.Float(string='Xe 35 chỗ', compute='_compute_team_option_car', inverse='_inverse_team_option_car', store=True, readonly=False)
    team_car_45_1 = fields.Float(string='Xe 45 chỗ', compute='_compute_team_option_car', inverse='_inverse_team_option_car', store=True, readonly=False)
    team_car_45_2 = fields.Float(string='Xe 45 chỗ', compute='_compute_team_option_car', inverse='_inverse_team_option_car', store=True, readonly=False)
    team_car_45_3 = fields.Float(string='Xe 45 chỗ', compute='_compute_team_option_car', inverse='_inverse_team_option_car', store=True, readonly=False)
    team_car_45_4 = fields.Float(string='Xe 45 chỗ', compute='_compute_team_option_car', inverse='_inverse_team_option_car', store=True, readonly=False)

    net_car_4 = fields.Float(string='Xe 4 chỗ', compute='_compute_net_option')
    net_car_7 = fields.Float(string='Xe 7 chỗ', compute='_compute_net_option')
    net_car_16 = fields.Float(string='Xe 16 chỗ', compute='_compute_net_option')
    net_car_29 = fields.Float(string='Xe 29 chỗ', compute='_compute_net_option')
    net_car_35 = fields.Float(string='Xe 35 chỗ', compute='_compute_net_option')
    net_car_45_1 = fields.Float(string='Xe 45 chỗ', compute='_compute_net_option')
    net_car_45_2 = fields.Float(string='Xe 45 chỗ', compute='_compute_net_option')
    net_car_45_3 = fields.Float(string='Xe 45 chỗ', compute='_compute_net_option')
    net_car_45_4 = fields.Float(string='Xe 45 chỗ', compute='_compute_net_option')

    usd_net_car_4 = fields.Float(string='Xe 4 chỗ', compute='_compute_net_option')
    usd_net_car_7 = fields.Float(string='Xe 7 chỗ', compute='_compute_net_option')
    usd_net_car_16 = fields.Float(string='Xe 16 chỗ', compute='_compute_net_option')
    usd_net_car_29 = fields.Float(string='Xe 29 chỗ', compute='_compute_net_option')
    usd_net_car_35 = fields.Float(string='Xe 35 chỗ', compute='_compute_net_option')
    usd_net_car_45_1 = fields.Float(string='Xe 45 chỗ', compute='_compute_net_option')
    usd_net_car_45_2 = fields.Float(string='Xe 45 chỗ', compute='_compute_net_option')
    usd_net_car_45_3 = fields.Float(string='Xe 45 chỗ', compute='_compute_net_option')
    usd_net_car_45_4 = fields.Float(string='Xe 45 chỗ', compute='_compute_net_option')
