...
class AsianSpreadsheetOption(models.Model):
    ...
    car_35 = fields.Float(string='Xe 35 chỗ (15)', compute='_compute_car_x')
    car_45_1 = fields.Float(string='Xe 45 chỗ (21)', compute='_compute_car_x')
    car_45_2 = fields.Float(string='Xe 45 chỗ (25)', compute='_compute_car_x')
    car_45_3 = fields.Float(string='Xe 45 chỗ (30)', compute='_compute_car_x')
